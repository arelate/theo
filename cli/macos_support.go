...
func macOsFindGogGameInfo(id string, ii *InstallInfo, rdx redux.Readable) (string, error) {
...
func macOsFindBundleApp(id string, ii *InstallInfo, rdx redux.Readable) (string, error) {
